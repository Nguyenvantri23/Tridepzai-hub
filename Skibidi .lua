...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=101277172387327";
...
v16.Home:AddButton({
    Title = "Remember:",
    Description = "This is not the real TriDepZai Hub, but a fake version made by Trí Nguyễn.",
    Callback = function()
        setclipboard("");
    end
});
