...
Toggle = Settings:AddToggle("Toggle", {Title = "Đánh Siêu Nhanh", Default = true})
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Icon = "rbxassetid://75665151362032";
    Duration = 1e5;
	Button1 = "Yes";
	Button2 = "No";
})
...
ImageLabel.Name = "Tringuyen Test"
...
ImageLabel.Image = "http://www.roblox.com/asset/?id= 75665151362032"
